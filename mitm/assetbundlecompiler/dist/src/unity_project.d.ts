...
export declare function copyAssetsInProject(context: BuildContext, assetsPath: String): Promise<void>;
export declare function generateAssetBundle(context: BuildContext, buildOptions: Set<string>, buildTarget: BuildTarget, unityLogger?: logger.SimpleLogger, signalAssetProcessed?: logger.SimpleLogger): Promise<IAssetBundleManifest>;
export declare function moveGeneratedAssetBundle(context: BuildContext, finalDest: fs.WriteStream, finalManifestDest: fs.WriteStream | null, overwrite: boolean, target: 'iOS' | 'Android'): Promise<void>;
